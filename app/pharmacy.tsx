...
const PRACTICES: Record<string, Practice[]> = {
  ...
  fatigue: [
    ...
    { id: "f3", emoji: "🧘", title: "Йога-нідра 10 хв", duration: "10 хв", durationSec: 600, color: COLORS.purple, description: "Глибоке відновлення через усвідомлену релаксацію. Замінює 1 годину сну.", steps: ["Ляж на спину, очі закрий", "Відчуй тяжкість правої руки... лівої руки...", "Відчуй тяжкість правої ноги... лівої ноги...", "Відчуй тяжкість всього тіла", "Уяви себе на теплому пляжі", "Просто спостерігай за диханням 5 хвилин", "Повільно поверни увагу до тіла", "Потягнись і відкрий очі"] },
  ],
  focus: [
    ...
    { id: "fo2", emoji: "🧠", title: "Дихання для фокусу", duration: "3 хв", durationSec: 180, color: COLORS.success, description: "Активує префронтальну кору мозку. Покращує концентрацію на 40%.", steps: ["Сядь прямо, закрий очі", "Вдих через ніс — 4 секунди", "Видих через ніс — 4 секунди", "Повтори 10 разів", "Відкрий очі — ти готовий до роботи", "Одразу переходь до задачі без відволікань"] },
  ...
  anxiety: [
    { id: "a1", emoji: "💙", title: "Квадратне дихання", duration: "4 хв", durationSec: 240, color: COLORS.info, description: "Техніка морських котиків США для контролю тривоги в стресових ситуаціях.", steps: ["Вдих — 4 секунди", "Затримка — 4 секунди", "Видих — 4 секунди", "Затримка — 4 секунди", "Повтори 8 разів", "Тривога відступить протягом 2 хвилин"] },
