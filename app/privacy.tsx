...
const CONTACT_EMAIL = "privacy@luma.app";
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Section title="1. Про застосунок">
          Luma — персональний застосунок для відстеження енергії та емоційного стану. Ми серйозно ставимось до захисту твоїх персональних даних. Ця Політика пояснює, які дані ми збираємо, як використовуємо і як захищаємо.
        </Section>
        ...
        <Section title="4. Як ми використовуємо дані">
          ...
          <BulletItem>Формування контексту для AI-чату Luma (ім'я, score, цілі, останні відповіді)</BulletItem>
        ...
        <Section title="5. Передача даних третім сторонам">
          ...
          <SubItem title="Luma AI API (luma-api.auto-poster-ai.com)">
            AI-асистент Luma отримує контекст для відповідей: ім'я, score, стрік, мета, останні відповіді. Дані передаються по HTTPS і не зберігаються на сервері після генерації відповіді.
          </SubItem>
        ...
        <Section title="9. Діти">
          Luma не призначений для дітей віком до 13 років (COPPA) та до 16 років на території ЄС (GDPR). Ми свідомо не збираємо дані осіб молодше цього віку. Якщо ти вважаєш, що дитина зареєструвалась — напиши нам.
        </Section>

        <Section title="10. Медичний дисклеймер">
          Luma не є медичним засобом і не надає медичних консультацій. Практики в розділі "Енергетична аптечка" носять інформаційний та загальнооздоровчий характер. При наявності психічних або фізичних розладів здоров'я зверніться до кваліфікованого спеціаліста.
        </Section>
